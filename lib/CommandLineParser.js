...
import { OptionParser, recommendedNodeVersion } from '../index.js'
...
class CommandLineParser {
  ...
  constructor (dirname) {
    ...
    this._packageJson = dirname == null
      ? this.packageJson
      : JSON.parse(
  ...
  help (shortKey, longKey, helpText) {
    ...
    this.flag(shortKey, longKey, () => {
      const recommendedVersion = recommendedNodeVersion(this.packageJson)
